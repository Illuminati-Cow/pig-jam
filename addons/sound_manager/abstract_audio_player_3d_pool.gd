...
func get_player_with_resource(resource: AudioStream) -> AudioStreamPlayer3D:
...
func get_busy_player_with_resource(resource: AudioStream) -> AudioStreamPlayer3D:
...
func fade_volume(player: AudioStreamPlayer3D, from_volume: float, to_volume: float, duration: float) -> AudioStreamPlayer3D:
...
func _remove_tween(player: AudioStreamPlayer3D) -> void:
...
func _on_fade_completed(player: AudioStreamPlayer3D, tween: Tween, from_volume: float, to_volume: float, duration: float):
	_remove_tween(player)
